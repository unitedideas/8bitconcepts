...
Generated: 2026-05-22 04:32 UTC
...
Observed signal: 270 indexed roles, tracked company, $374,000 average published salary, top tags: alignment, llm, distributed-systems
Sample roles: Research Engineer, Performance RL; Research Lead, Training Insights
Workplace mix: hybrid: 11, onsite: 1
Longform decision: Paper trigger: Anthropic is a top-scale AI hiring signal with 270 indexed roles.
...
```text
Looking at public AI hiring as a market signal: @AnthropicAI has 270 indexed AI/ML roles on AI Dev Board, with current tags clustering around alignment, llm, distributed-systems. Avg published salary: $374,000.
...
1. 270 indexed AI/ML roles in AI Dev Board.
2. Current sample tags cluster around alignment, llm, distributed-systems, search.
3. Sample roles include Research Engineer, Performance RL; Research Lead, Training Insights; Product Manager, Developer Productivity.
4. Avg published salary in the indexed sample: $374,000.
