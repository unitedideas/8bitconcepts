...
Generated: 2026-05-23 15:21 UTC
...
Observed signal: 89 indexed roles, tracked company, salary not published average published salary, top tags: generative-ai, search, agents
Sample roles: Software Engineer, Data Infrastructure; Machine Learning Intern/Co-op (Fall, 2026)
Workplace mix: remote: 10, onsite: 1, hybrid: 1
...
```text
Looking at public AI hiring as a market signal: @cohere has 89 indexed AI/ML roles on AI Dev Board, with current tags clustering around generative-ai, search, agents. Avg published salary: salary not published.
...
1. 89 indexed AI/ML roles in AI Dev Board.
2. Current sample tags cluster around generative-ai, search, agents, nlp.
3. Sample roles include Software Engineer, Data Infrastructure; Machine Learning Intern/Co-op (Fall, 2026); Forward Deployed Engineer, Agentic Platform (UK/Europe).
