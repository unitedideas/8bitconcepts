...
Generated: 2026-05-06 19:50 UTC
...
Observed signal: 106 indexed roles, #10 by indexed role count, $255,425 average published salary, top tags: autonomous-vehicles, pytorch, generative-ai
Sample roles: Senior Staff Engineer, DevAI; Staff Software Engineer, DevAI
Workplace mix: onsite: 11, hybrid: 9
...
Source fetch errors:
- nhs_profile: HTTP Error 404: Not Found

#### X

```text
Looking at public AI hiring as a market signal: @Waymo has 106 indexed AI/ML roles on AI Dev Board, with current tags clustering around autonomous-vehicles, pytorch, generative-ai. Avg published salary: $255,425. Waymo is #10 by indexed role count in the current AI Dev Board sample.
...
1. 106 indexed AI/ML roles in AI Dev Board.
2. Current sample tags cluster around autonomous-vehicles, pytorch, generative-ai, deep-learning.
3. Sample roles include Senior Staff Engineer, DevAI; Staff Software Engineer, DevAI; Senior Software Engineer,  DevAI.
4. Avg published salary in the indexed sample: $255,425.
