...
Observed signal: 88 indexed roles, #13 by indexed role count, $235,000 average published salary, top tags: generative-ai, search, agents
Sample roles: Fine-Tuning Engineer; Backend Engineer - Enterprise AI Platform
Workplace mix: remote: 15, hybrid: 3, onsite: 2
...
```text
Looking at public AI hiring as a market signal: @cohere has 88 indexed AI/ML roles on AI Dev Board, with current tags clustering around generative-ai, search, agents. Avg published salary: $235,000. Cohere is #13 by indexed role count in the current AI Dev Board sample.
...
1. 88 indexed AI/ML roles in AI Dev Board.
2. Current sample tags cluster around generative-ai, search, agents, cloud.
3. Sample roles include Fine-Tuning Engineer; Backend Engineer - Enterprise AI Platform; Engineering Manager, Agentic Platform.
