...
Generated: 2026-05-15 19:20 UTC
...
Observed signal: 90 indexed roles, tracked company, salary not published average published salary, top tags: search, generative-ai, agents
...
```text
Looking at public AI hiring as a market signal: @cohere has 90 indexed AI/ML roles on AI Dev Board, with current tags clustering around search, generative-ai, agents. Avg published salary: salary not published.
...
1. 90 indexed AI/ML roles in AI Dev Board.
2. Current sample tags cluster around search, generative-ai, agents, nlp.
